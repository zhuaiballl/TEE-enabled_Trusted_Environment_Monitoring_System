...
- {pin_num: '12', pin_signal: PIO0_12/FC3_TXD_SCL_MISO_WS/SD1_BACKEND_PWR/FREQME_GPIO_CLK_B/SCT_GPI7/SD0_POW_EN/SWDIO/FC6_TXD_SCL_MISO_WS/SECURE_GPIO0_12/ADC0_10,
  label: Ligth GPIO}
...
- pin_list:
  ...
  - {pin_num: '56', peripheral: SECGPIO, signal: 'SECPIO0, 18', pin_signal: PIO0_18/FC4_CTS_SDA_SSEL0/SD0_WR_PRT/CTIMER1_MAT0/SCT0_OUT1/PLU_IN3/SECURE_GPIO0_18/ACMP0_C,
    asw: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    IOCON->PIO[0][1] = ((IOCON->PIO[0][1] &
     ...
     IOCON->PIO[0][18] = ((IOCON->PIO[0][18] &
                         ...
                         /* Selects pin function.
                          * : PORT018 (pin 56) is configured as SECURE_GPIO0_18. */
                         | IOCON_PIO_FUNC(0x0Au)
                         ...
                         | IOCON_PIO_MODE(PIO0_18_MODE_PULL_DOWN)
