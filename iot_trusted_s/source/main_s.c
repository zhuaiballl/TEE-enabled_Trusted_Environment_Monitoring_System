...
int main(void)
{
    ...
    *Rtc_Alarm	   = true;
    ...
    if(USE_NB_IOT){AppNBInit();}//9600  N
    else{App4GInit();}	//38400 E
...
//    		App_Set_RTC(rtcdate);
    ...
    App_Set_RTC(rtcdate);
    if(GPS_try_time==GPS_TIME_LIMIT)PRINTF("GPS TIME OUT!!");
    /*
    while(1)
    {
    	int image_sum	= app_camera_read();
    	image_sum=0;
    }
    */
    /*char str[1000];
