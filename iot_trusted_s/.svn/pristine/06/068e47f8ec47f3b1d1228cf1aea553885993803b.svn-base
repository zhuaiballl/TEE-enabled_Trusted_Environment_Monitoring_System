...
#define REGION_0_END 0x0003FFFFU
#define REGION_1_BASE 0x20030000U
#define REGION_1_END 0x2003FFFFU
#define REGION_2_BASE 0x10052000U
#define REGION_2_END 0x10056FFFU
#define REGION_3_BASE 0x20040000U
#define REGION_3_END 0x200403FFU
#define REGION_4_BASE 0x40000000U
#define REGION_4_END 0x40000FFFU
#define REGION_5_BASE 0x40086000U
#define REGION_5_END 0x40086FFFU
...
- ahb:
  - regions:
    ...
    - relative_region: {memory: PROGRAM_FLASH, security: ns_user, start: '0x00020000', size: '0x00030000'}
    - relative_region: {memory: PROGRAM_FLASH, security: s_priv, start: '0x00050000', size: '0x00008000'}
    - relative_region: {memory: PROGRAM_FLASH, security: ns_user, start: '0x00058000', size: '0x00048000'}
    ...
    - relative_region: {memory: SRAM1, security: s_priv, start: '0x00000000', size: '0x00010000'}
    ...
    - relative_region: {memory: SRAM4, security: ns_user, start: '0x00000000', size: '0x00003000'}
    - relative_region: {memory: SRAM4, security: s_priv, start: '0x00003000', size: '0x00001000'}
  ...
  - peripherals:
    - ns_user: {id: ADC0, id: AHB_SECURE_CTRL, id: ANACTRL, id: CRC_ENGINE, id: CTIMER0, id: CTIMER1, id: CTIMER2, id: CTIMER3, id: CTIMER4, id: DBGMAILBOX, id: DMA0,
      id: DMA1, id: FLASH, id: FLEXCOMM0, id: FLEXCOMM1, id: FLEXCOMM2, id: FLEXCOMM3, id: FLEXCOMM4, id: FLEXCOMM5, id: FLEXCOMM6, id: FLEXCOMM7, id: GINT0, id: GINT1,
      ...
      id: SCT0, id: SDIF, id: SECGPIO, id: SECPINT, id: SPI8, id: SYSCON, id: SYSCTL, id: USB0, id: USBFSH, id: USBHSD, id: USBHSH, id: USBPHY, id: UTICK0, id: WWDT}
    - s_priv: {id: CASPER, id: IOCON}
  - interrupts:
    - masking:
      - Non-masked: {id: acmp_capt_irq, id: adc_irq, id: casper_irq, id: ctimer0_irq, id: ctimer1_irq, id: ctimer2_irq, id: ctimer3_irq, id: ctimer4_irq, id: flexcomm0_irq,
        ...
        id: utick_irq}
    - security:
      - Secure: {id: acmp_capt_irq, id: adc_irq, id: casper_irq, id: ctimer0_irq, id: ctimer1_irq, id: ctimer2_irq, id: ctimer3_irq, id: ctimer4_irq, id: flexcomm1_irq,
        id: flexcomm2_irq, id: flexcomm3_irq, id: flexcomm4_irq, id: flexcomm5_irq, id: flexcomm6_irq, id: flexcomm7_irq, id: global_irq0, id: global_irq1, id: lspi_hs_irq,
        ...
        id: plu_irq, id: pq_irq, id: qddkey_irq, id: rtc_irq, id: sct_irq, id: sdio_irq, id: sdma0_irq, id: sdma1_irq, id: sec_hypervisor_call_irq, id: sec_int0,
        id: sec_int1, id: sec_vio_irq, id: sha_irq, id: sys_irq, id: usb0_irq, id: usb0_needclk_irq, id: usb1_irq, id: usb1_needclk_irq, id: usb1_utmi_irq, id: utick_irq}
      - Non-secure: {id: flexcomm0_irq}
  - pins_masks:
    - pio0:
...
- sau:
  ...
  - regions:
    - region: {index: '0', enabled: 'true', security: ns, start: '0x00020000', size: '0x00020000'}
    - region: {index: '1', enabled: 'true', security: ns, start: '0x20030000', size: '0x00010000'}
    - region: {index: '2', enabled: 'true', security: nsc, start: '0x10052000', size: '0x00005000'}
    - region: {index: '3', enabled: 'true', security: ns, start: '0x20040000', size: '0x00000400'}
    - region: {index: '4', enabled: 'true', security: ns, start: '0x40000000', size: '0x00001000'}
    - region: {index: '5', enabled: 'true', security: ns, start: '0x40086000', size: '0x00001000'}
...
- user_memory_regions:
  - user_memory_region: {id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x00020000'}
  - user_memory_region: {id: Region_2, security: nsc_priv, name: Veneer Table, start: '0x10052000', size: '0x00005000'}
  ...
  - user_memory_region: {id: Region_4, security: ns_user, name: Non-secure Code, description: Privilege check is disabled so reset value (NS-User) can be used,
    start: '0x00020000', size: '0x00020000'}
  - user_memory_region: {id: Region_5, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege check is disabled so reset value (NS-User) can
      be used. ', start: '0x20030000', size: '0x00010000'}
  - user_memory_region: {id: Region_6, security: ns_user, name: Secure_variable, start: '0x20040000', size: '0x00000400'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
void BOARD_InitTrustZone()
{
	...
	AHB_SECURE_CTRL->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_FLASH_MEM_RULE[1] = 0x00000300U;
	...
	AHB_SECURE_CTRL->SEC_CTRL_RAM4[0].MEM_RULE[0] = 0x00003000U;
	AHB_SECURE_CTRL->SEC_CTRL_USB_HS[0].MEM_RULE[0] = 0;

	//--- Security level configuration of peripherals --------------------
	AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE0_MEM_CTRL0 = 0x00000030U;
	...
	AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT10[0].SLAVE0_RULE = 0x00300000U;
	...
	*/
    ...
    AHB_SECURE_CTRL->SEC_CTRL_AHB2[0].SEC_CTRL_AHB2_0_SLAVE_RULE           = 0x00300000U;
